...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://V:V@cluster0.u2yffnl.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "serial0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'wmteams')
...
LOG_MSG = "{}  Iꜱ Rᴇsᴛᴀʀᴛᴇᴅ....✨ @vis_hnu_bot\n\n🗓️ Dᴀᴛᴇ : {}\n⏰ Tɪᴍᴇ : {}\n\n©️ Cᴏᴩʏʀɪɢʜᴛ: THIS IS VISHNU A   !"
